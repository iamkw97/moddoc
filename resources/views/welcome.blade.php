...
<body>
    ...
    <div id="topbar" class="d-flex align-items-center fixed-top">
        <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
            <div class="align-items-center d-none d-md-flex">
                <i class="bi bi-clock"></i> We are available for 24 hours.
            </div>
            <div class="d-flex align-items-center">
                <i class="bi bi-phone"></i> Call us now +94 000 000 000
            </div>
        </div>
    </div>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <!-- <a href="index.html" class="logo me-auto"><img src="{{ asset('welcome/img/logo.png') }}"
                    alt=""></a>  -->
        ...
        <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active"
                    style="background-image: url({{ asset('welcome/img/slide/slide-1.jpg') }})">
                    <div class="container">
                        <h2>Welcome to <span>MedDOC</span></h2>
                        <p>The quickest way to find and echannelling a doctor near you. Get access to 5,500+ specialist
                ...
                <!-- Slide 2 -->
                <div class="carousel-item" style="background-image: url({{ asset('welcome/img/slide/slide-2.jpg') }})">
                    <div class="container">
                        <h2>Welcome to <span>MedDOC</span></h2>
                        <p>The quickest way to find and echannelling a doctor near you. Get access to 5,500+ specialist
                            doctors in over 260 hospitals to echannel your appointment. 24x7 Supervision. 260+ Prominent
                ...
                <!-- Slide 3 -->
                <div class="carousel-item" style="background-image: url({{ asset('welcome/img/slide/slide-3.jpg') }})">
                    <div class="container">
                        <h2>Welcome to <span>MedDOC</span></h2>
                        <p>The quickest way to find and echannelling a doctor near you. Get access to 5,500+ specialist
                            doctors in over 260 hospitals to echannel your appointment. 24x7 Supervision. 260+ Prominent
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="image col-lg-6 order-1 order-lg-2"
                        style='background-image: url("{{ asset('welcome/img/features.jpg') }}");' data-aos="zoom-in">
                    </div>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('welcome/img/testimonials/testimonials-2.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>Sara Wilsson</h3>
                                <h4>Designer</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('welcome/img/testimonials/testimonials-3.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>Jena Karlis</h3>
                                <h4>Store Owner</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('welcome/img/testimonials/testimonials-4.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>Matt Brandon</h3>
                                <h4>Freelancer</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('welcome/img/testimonials/testimonials-5.jpg') }}"
                                    class="testimonial-img" alt="">
                                <h3>John Larson</h3>
                                <h4>Entrepreneur</h4>
                            </div>
